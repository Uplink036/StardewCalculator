...
public class StardewDataTests
{
    ...
    public void LoadVanillaPierres()
    {
        ...
        Assert.That(pierresVanilla.data.Count(), Is.EqualTo(6), message=string.Format("Found crops: {0}", pierresVanilla.data));
    }
    ...
    public void LoadVanillaJoja()
    {
        ...
        Assert.That(jojaVanilla.data.Count(), Is.EqualTo(1), message=string.Format("Found crops: {0}", jojaVanilla.data));
    }
    ...
    public void LoadVanillaOasis()
    {
        ...
        Assert.That(oasisVanilla.data.Count(), Is.EqualTo(1), message=string.Format("Found crops: {0}", oasisVanilla.data));
    }
    ...
    public void LoadExpandedPierres()
    {
        ...
        Assert.That(pierresExpanded.data.Count(), Is.EqualTo(1), message=string.Format("Found crops: {0}", pierresExpanded.data));
    }
    ...
    public void LoadExpandedJoja()
    {
        ...
        Assert.That(jojaExpanded.data.Count(), Is.EqualTo(1), message=string.Format("Found crops: {0}", jojaExpanded.data));
    }
    ...
    public void LoadExpandedOasis()
    {
        ...
        Assert.That(oasisExpanded.data.Count(), Is.EqualTo(1), message=string.Format("Found crops: {0}", oasisExpanded.data));
    }
